...
export const skillsData = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "NextJs", icon: SiNextdotjs, level: 70 },
...
export const projectsData = [
  {
    ...
    description: "Comprehensive educational app for freshman university students featuring AI-powered Q&A, PDF resources, NotePad and GPA Calculator and Goal Setting",
    image: "/3.png",
  ...
  {
    id: 2,
    title: "General Labs E-commerce Website",
    description: "Client: General Labs PLC. A professional e-commerce website for a company specializing in medical and laboratory equipment and supplies.",
    image: "/1.jpg",
    tags: ["E-Commerce", "NextJs", "Database"],
    demoUrl: "https://generallabs.store",
    githubUrl: "#"
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: "A line-following robot for autonomous navigation and circuit design.",
    image: "/robot.jpg",
    tags: ["Proteus", "Arduino", "Circuit Design"],
    demoUrl: "https://play.google.com/store/apps/details?id=com.ethiopiancalendar",
    githubUrl: "#"
  },
  ...
  { 
    id: 8,
    title: "Rosi English",
    description: "comprehensive English learning platform with interactive quizzes, exams, and learning resources.",
    image: '/Rosi/rosi1.png',
    tags: ["CSS", "JavaScript", "React"],
    demoUrl: "https://rosi-english.vercel.app",
    githubUrl: "https://github.com/yoh-space"
...
export const aboutData = {
  ...
  description: [
    ...
    "I'm currently competting my bachelor's degree in the field of Software Engineering at Bahir Dar University, Bahir Dar, Ethiopia, where I work on creating innovative mobile and web solutions for clients.",
